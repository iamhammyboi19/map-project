...
var getHelpFunc = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(help) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              alert("".concat(help, " is on the way"));
            }
  ...
  return function getHelpFunc(_x) {
...
var MapApp = /*#__PURE__*/_createClass(function MapApp() {
  ...
  helpBtn.addEventListener("click", _classPrivateMethodGet(this, _myBtn, _myBtn2).bind(this));
}
/**
...
function _loadMap2(pos) {
  ...
  _classPrivateFieldGet(this, _mapCoords).push(latitude, longitude); // set map
  ...
  L.marker(_classPrivateFieldGet(this, _mapCoords)).addTo(_classPrivateFieldGet(this, _map)).bindPopup(L.popup({
    ...
    autoClose: false,
    closeOnClick: false
  })).setPopupContent("Welcome to school").openPopup();
...
var app = new MapApp();
},{"./config.js":"config.js","./helpers.js":"helpers.js","axios":"../../node_modules/axios/index.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
